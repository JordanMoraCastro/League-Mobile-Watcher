...
namespace League_Watcher.ViewModels.Match
{
    ...
    class MarchInformationViewModel
    {
    ...
    public class Style
    {
        ...
        public List<Selection> selections { get; } = new List<Selection>();
    ...
    public class Participant
    {
        ...
        {
            get { return win == true ? "Victoria":"Derrota"; }   // get method
            set { winner = value; }  // set method
        }
    ...
    public class Team
    {
        public List<Ban> bans { get; } = new List<Ban>();
